...
void Interface::renderInfoBatiment(sf::RenderWindow *renderWindow, sf::Font font, Batiment *batiment, float x, float y) {
	...
	nom = "Nom : " + batiment->getNom();
	description = "Description : " + batiment->getDescription();

	vie = "Vie : ";
	vie = vie + std::to_string(batiment->getPvRestant()) + "/10";

	/*vision = "Vision : ";
	vision = vision + std::to_string(batiment->getChampVision() - 1);*/
...
void Interface::renderBatiment(sf::RenderWindow *renderWindow, sf::Font font, Batiment *batiment) {
